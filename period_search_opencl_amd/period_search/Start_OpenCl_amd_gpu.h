...
class clAmdGpuStrategy : public clStrategy
{
public:
    clAmdGpuStrategy() {};
    ~clAmdGpuStrategy() = default;
    ...
    cl_int EnqueueMapWriteCL_FR(cl_command_queue queue, cl_mem CL_FR, size_t frSize, void* pfr) const;

    cl_int EnqueueUnmapCL_FR(cl_command_queue queue, cl_mem CL_FR, size_t frSize, void* pfr) const;

    cl_int EnqueueUnmapWriteCL_FR(cl_command_queue queue, cl_mem CL_FR, size_t frSize, void* pfr) const;
};
