...
\
			...
			avx_d1=_mm256_add_pd(avx_d1,_mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(avx_Area,avx_lmu),avx_lmu0),avx_inv));
// end of inner_calc
#define INNER_CALC_DSMU \
	  ...
	  avx_s=_mm256_mul_pd(_mm256_mul_pd(avx_lmu,avx_lmu0),_mm256_add_pd(avx_cl,_mm256_mul_pd(avx_cls,avx_inv))); \
